      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="flex flex-col items-start max-w-4xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold tracking-widest uppercase bg-[#ff5500]/10 text-[#ff5500] border border-[#ff5500]/25 mb-6 shadow-xs"
          >
          ...
          >
            {[
              ...
              return (
                <span
                  key={idx}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/90 border border-neutral-200/90 text-neutral-800 font-semibold shadow-xs"
                >
          ...
          >
            <MagneticButton
              ...
              variant="primary"
              className="py-3.5 px-7 text-sm sm:text-base shadow-[0_12px_35px_rgba(255,85,0,0.35)]"
            >
            ...
            <MagneticButton
              ...
              variant="outline"
              className="py-3.5 px-7 text-sm sm:text-base border-neutral-300 text-neutral-800 hover:border-[#ff5500] hover:text-[#ff5500]"
            >
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-neutral-100 hover:bg-neutral-900 hover:text-white text-neutral-700 border border-neutral-200/80 transition-all duration-200 shadow-xs cursor-pointer"
              aria-label="GitHub"
            >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 border border-neutral-200/80 shadow-xs text-xs font-mono text-neutral-600">
        ...
        <motion.div
          ...
          className="w-full grid grid-cols-2 md:grid-cols-4 gap-4 p-5 sm:p-6 rounded-2xl bg-white/80 border border-neutral-200/80 shadow-xl backdrop-blur-lg text-center mt-12"
        >
